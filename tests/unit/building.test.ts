...
import { planRoute, traverseSegment } from '../../src/lib/navigation';
...
it('new rooms and both floor connections have swept collision-free paths',()=>{
  const doors=objects.filter(o=>o.kind==='door').map(o=>o.id);
  for(const id of ['hr-desk','training-table','wellness-sofa','lift-1','stairs-1','desk-b21','sky-table','lift-2','stairs-2']){
