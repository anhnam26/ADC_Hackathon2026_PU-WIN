...
export const categoryLabels: Record<Category, string> = {
  entrance: "Lối đi không có bậc thang",
  furniture: "Bàn làm việc & lối đi",
  restroom: "Nhà vệ sinh phù hợp",
  captions: "Phụ đề & tài liệu họp",
  quiet: "Không gian ít tiếng ồn",
  guidance: "Hướng dẫn & người hỗ trợ",
};
...
export const issueSchema = z.object({
  ...
  requestedSupport: z.string().max(1000),
...
export const taskSchema = z.object({
  ...
  title: z.string(),
  locationId: id,
  ownerTeam: z.enum(["HR", "Facilities"]),
  assignee: z.string(),
  ...
  history: z.array(
    z.object({ at: z.string(), actor: z.string(), message: z.string() }),
  ),
});
